...
<h1 style="color: white;">Welcome: <%=(String)session.getAttribute("admin_name") %></h1> <h2 style="color: white; text-align: center;">Search Results</h2>
		...
		%>
		    ...
		    %>
              ...
              <tr class="row100">
                ...
                <br>
                <a href="modifybook2.jsp?bookId=<%=book.getBookId()%>">Modify Details</a>
                <br>
                <a href="uploadbook2.jsp?bookId=<%=book.getBookId() %>">Upload New PDF</a>
                <br>
                <a href="deletebook2.jsp?bookId=<%=book.getBookId() %>" onclick="return confirm('Do you want to Delete?')">Delete</a></td>
              </tr>
              <%
					  }
						  }
