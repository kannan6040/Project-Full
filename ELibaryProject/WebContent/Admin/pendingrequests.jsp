...
<h2 style="color: white; text-align: center;">Pending Requests</h2>
...
<br><br>
 ...
 //         ArrayList<Book> books=null;
 		  ArrayList<User> users=UserBl.getUsersApprovalList();
		...
		%>
		    ...
		    %>
              ...
              <tr class="row100">
                ...
                <a href="approverequest.jsp?emailId=<%=user.getEmailId()%>" >Approve</a>
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                 <a href="denyrequest.jsp?emailId=<%=user.getEmailId()%>" >Deny</a>
              ...
              <%
							         ...
							         <tr class="row100">
                <td  colspan="10" align="center"> <span >No Pending Requests found </span> </td>
                </tr>
