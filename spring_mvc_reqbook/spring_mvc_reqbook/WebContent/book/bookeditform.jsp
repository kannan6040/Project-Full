...
<nav style="background: rgba(0,0,0,.8);height: 70px;font-size: 20px; "  class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
       ...
       <form:form method="POST" action="/spring_mvc_reqbook/editsave" modelAttribute="book">    
        <table >    
        
        <tr>  
        <td></td>    
         <td><form:hidden  path="requestid" /></td>  
         </tr>   
         
         <tr>    
          <td style="color:white;">Book Name : </td>   
          <td><form:input style="background: rgba(0,0,0,.8); color:white;" path="bookname"  /></td> 
          <form:errors path="bookname" cssClass="error"/>
         </tr>    
         
         <tr>    
          <td style="color:white;">Author Name :</td>    
          <td><form:input style="background: rgba(0,0,0,.8); color:white;" path="authorname" /></td> 
          <form:errors path="authorname" cssClass="error"/>  
         </tr>   
         
         <tr>    
          <td style="color:white;">Published Year :</td>    
